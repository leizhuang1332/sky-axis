/**
 * Shared sidebar entry injection core (vendored copy).
 *
 ...
 *
 * Vendored from /Users/Ray/TraeProjects/dsh-web-ui/shared/client/sidebar-entry-core.ts
 * (synced across dsh-task-board / dsh-ssh / dsh-skill-explorer). Do not edit
 * this copy in isolation — edit the shared source and re-run the sync.
 */
