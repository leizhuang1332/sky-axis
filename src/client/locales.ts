...
export const zh = {
  ...
  /* PR-D 迭代 6：#1 调整 task list drawer */
  'requirement.detail.adjustTaskList.title': '调整 task list',
  'requirement.detail.adjustTaskList.intro': 'AI 已拆分 {n} 个任务；调整后重新提交',
  'requirement.detail.adjustTaskList.hint': '调整会替换当前 task list 并触发后续 stage 重新评估。',
  'requirement.detail.adjustTaskList.taskTitlePlaceholder': '任务标题',
  'requirement.detail.adjustTaskList.goalLabel': '目标',
  'requirement.detail.adjustTaskList.acceptanceLabel': '验收标准',
  'requirement.detail.adjustTaskList.acceptanceHint': '每行一条',
  'requirement.detail.adjustTaskList.acceptancePlaceholder': '例：返回结构与文档一致',
  'requirement.detail.adjustTaskList.dependenciesLabel': '依赖其它 task',
  'requirement.detail.adjustTaskList.dependenciesHint': '（按住 Ctrl/Cmd 多选；可空）',
  'requirement.detail.adjustTaskList.filesLabel': '预期修改文件',
  'requirement.detail.adjustTaskList.filesPlaceholder': '每行一个路径…',
  'requirement.detail.adjustTaskList.addRow': '+ 添加 task',
  'requirement.detail.adjustTaskList.removeRow': '删除该 task',
  'requirement.detail.adjustTaskList.confirmSave': '保存修改',
  'requirement.detail.adjustTaskList.cancel': '取消',

  /* PR-D 迭代 6：#3 介入队列应答 drawer */
  'requirement.detail.queue.respond.title': '回应介入项',
  'requirement.detail.queue.respond.approvalTitle': '审批请求',
  'requirement.detail.queue.respond.approvalHint': '可选附加说明',
  'requirement.detail.queue.respond.questionTitle': '提问',
  'requirement.detail.queue.respond.questionMissing': '（问题内容缺失）',
  'requirement.detail.queue.respond.questionTextPlaceholder': '请输入回答…',
  'requirement.detail.queue.respond.confirmYes': '是',
  'requirement.detail.queue.respond.confirmNo': '否',
  'requirement.detail.queue.respond.reviewTitle': '审阅',
  'requirement.detail.queue.respond.toolCallUnknown': '（工具调用描述缺失）',
  'requirement.detail.queue.respond.modifyReasonLabel': '修改建议',
  'requirement.detail.queue.respond.approve': '批准',
  'requirement.detail.queue.respond.reject': '拒绝',
  'requirement.detail.queue.respond.confirm': '通过',
  'requirement.detail.queue.respond.needModify': '需修改',
  'requirement.detail.queue.respond.cancel': '取消',

  /* PR-D 迭代 6：#4 失败 task 4 选 1 modal */
  'requirement.detail.failedTask.title': 'task 失败 — 选择下一步',
  'requirement.detail.failedTask.subtitle': 'task「{title}」连续 {n} 次失败',
  'requirement.detail.failedTask.hint': '该决策会写入 task 的 subHistory，可在审计日志追溯。',
  'requirement.detail.failedTask.option.redo': '重做',
  'requirement.detail.failedTask.option.redoDesc': '重新执行该 task（保留其它 task 状态）',
  'requirement.detail.failedTask.option.rewindPlan': '改 plan',
  'requirement.detail.failedTask.option.rewindPlanDesc': '暂回 plan 阶段重新拆分',
  'requirement.detail.failedTask.option.skip': '跳过',
  'requirement.detail.failedTask.option.skipDesc': '标记为跳过，继续下一 task',
  'requirement.detail.failedTask.option.abort': '中止',
  'requirement.detail.failedTask.option.abortDesc': '中止 AI session，人工接管',
  'requirement.detail.failedTask.reasonLabel': '原因（可选）',
  'requirement.detail.failedTask.reasonPlaceholder': '为什么选择这个决策…',
  'requirement.detail.failedTask.confirm': '确认',
  'requirement.detail.failedTask.cancel': '取消',

  /* PR-D 迭代 6：#5 阶段 Gate modal */
  'requirement.detail.stageGate.title': '是否进入下一阶段？',
  'requirement.detail.stageGate.subtitle': '{fromStage} 阶段已完成',
  'requirement.detail.stageGate.nextStage': '下一阶段',
  'requirement.detail.stageGate.taskProgress': 'task 完成度',
  'requirement.detail.stageGate.drift': 'drift 综合分',
  'requirement.detail.stageGate.driftUnknown': '未知',
  'requirement.detail.stageGate.rewinds': 'rewind 次数',
  'requirement.detail.stageGate.hint': '决策会写入 stageHistory 的 outcome 字段。',
  'requirement.detail.stageGate.advance': '进入下一阶段',
  'requirement.detail.stageGate.stay': '暂留本阶段',

  /* PR-D 迭代 6：#2 SteerBar */
  'requirement.detail.steer.label': '插入指令（实时生效于下一个 task）',
  'requirement.detail.steer.placeholder': '比如：「接下来用 ESM 而非 CJS」「优先用 msw 而非 nock」',
  'requirement.detail.steer.send': '发送',
...
export const en: Record<SkyAxisKey, string> = {
  ...
  /* PR-D iteration 6: #1 AdjustTaskListDrawer */
  'requirement.detail.adjustTaskList.title': 'Adjust task list',
  'requirement.detail.adjustTaskList.intro': 'AI has split the work into {n} tasks — edit and submit.',
  'requirement.detail.adjustTaskList.hint': 'Adjustments replace the current task list and trigger a re-evaluation of subsequent stages.',
  'requirement.detail.adjustTaskList.taskTitlePlaceholder': 'Task title',
  'requirement.detail.adjustTaskList.goalLabel': 'Goal',
  'requirement.detail.adjustTaskList.acceptanceLabel': 'Acceptance criteria',
  'requirement.detail.adjustTaskList.acceptanceHint': 'One per line',
  'requirement.detail.adjustTaskList.acceptancePlaceholder': 'e.g. response shape matches the doc',
  'requirement.detail.adjustTaskList.dependenciesLabel': 'Depends on',
  'requirement.detail.adjustTaskList.dependenciesHint': '(Ctrl/Cmd-click to multi-select; optional)',
  'requirement.detail.adjustTaskList.filesLabel': 'Expected files',
  'requirement.detail.adjustTaskList.filesPlaceholder': 'One path per line…',
  'requirement.detail.adjustTaskList.addRow': '+ Add task',
  'requirement.detail.adjustTaskList.removeRow': 'Remove task',
  'requirement.detail.adjustTaskList.confirmSave': 'Save changes',
  'requirement.detail.adjustTaskList.cancel': 'Cancel',

  /* PR-D iteration 6: #3 Intervention respond drawer */
  'requirement.detail.queue.respond.title': 'Respond to intervention',
  'requirement.detail.queue.respond.approvalTitle': 'Approval request',
  'requirement.detail.queue.respond.approvalHint': 'Optional note',
  'requirement.detail.queue.respond.questionTitle': 'Question',
  'requirement.detail.queue.respond.questionMissing': '(question payload missing)',
  'requirement.detail.queue.respond.questionTextPlaceholder': 'Type your answer…',
  'requirement.detail.queue.respond.confirmYes': 'Yes',
  'requirement.detail.queue.respond.confirmNo': 'No',
  'requirement.detail.queue.respond.reviewTitle': 'Review',
  'requirement.detail.queue.respond.toolCallUnknown': '(tool call description missing)',
  'requirement.detail.queue.respond.modifyReasonLabel': 'Modify reason',
  'requirement.detail.queue.respond.approve': 'Approve',
  'requirement.detail.queue.respond.reject': 'Reject',
  'requirement.detail.queue.respond.confirm': 'Confirm',
  'requirement.detail.queue.respond.needModify': 'Need changes',
  'requirement.detail.queue.respond.cancel': 'Cancel',

  /* PR-D iteration 6: #4 Failed task 4-pick modal */
  'requirement.detail.failedTask.title': 'Task failed — pick a next step',
  'requirement.detail.failedTask.subtitle': 'Task "{title}" failed {n} times in a row',
  'requirement.detail.failedTask.hint': 'Your decision is recorded on the task subHistory for audit.',
  'requirement.detail.failedTask.option.redo': 'Redo',
  'requirement.detail.failedTask.option.redoDesc': 'Re-run this task (keep sibling task state)',
  'requirement.detail.failedTask.option.rewindPlan': 'Rewind plan',
  'requirement.detail.failedTask.option.rewindPlanDesc': 'Roll back to plan and re-split',
  'requirement.detail.failedTask.option.skip': 'Skip',
  'requirement.detail.failedTask.option.skipDesc': 'Mark skipped and move on',
  'requirement.detail.failedTask.option.abort': 'Abort',
  'requirement.detail.failedTask.option.abortDesc': 'Stop the AI session, take over manually',
  'requirement.detail.failedTask.reasonLabel': 'Reason (optional)',
  'requirement.detail.failedTask.reasonPlaceholder': 'Why this decision…',
  'requirement.detail.failedTask.confirm': 'Confirm',
  'requirement.detail.failedTask.cancel': 'Cancel',

  /* PR-D iteration 6: #5 Stage gate modal */
  'requirement.detail.stageGate.title': 'Advance to next stage?',
  'requirement.detail.stageGate.subtitle': '{fromStage} has completed',
  'requirement.detail.stageGate.nextStage': 'Next stage',
  'requirement.detail.stageGate.taskProgress': 'Task progress',
  'requirement.detail.stageGate.drift': 'Drift overall',
  'requirement.detail.stageGate.driftUnknown': 'unknown',
  'requirement.detail.stageGate.rewinds': 'Rewind count',
  'requirement.detail.stageGate.hint': 'This decision is recorded on stageHistory.outcome for audit.',
  'requirement.detail.stageGate.advance': 'Advance',
  'requirement.detail.stageGate.stay': 'Stay',

  /* PR-D iteration 6: #2 SteerBar */
  'requirement.detail.steer.label': 'Insert a steer (applies to the next task)',
  'requirement.detail.steer.placeholder': 'e.g. "use ESM, not CJS" / "prefer msw over nock"',
